        ...
        // For all other properties, only proceed if the property doesn't exist as an instance property
            ...
            // Handle non-event function properties
                ...
                if (isTemplateLiteral(descriptor.value)) {
                    ...
                    // Static string - evaluate once and set
                    el[key] = parseTemplateLiteral(descriptor.value, el);
                }
            }
            else {
...
export { MappedArray, adoptDocument, adoptNode, adoptStyleSheet, adoptWindow, bindReactiveAttribute, bindReactiveProperty, bindTemplate, clearStyleSheet, computedTemplate, createEffect, createElement, createReactiveProperty, DDOM as default, define, isTemplateLiteral, parseTemplateLiteral };
