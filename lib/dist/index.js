                    ...
                    if (typeof expr.map === 'function') {
                        ...
                        mappedArray = processedArray.map((item, index) => {
                            if (typeof item === 'object' && item !== null) {
                                return transform(expr.map, item);
                            }
                            return item;
                        });
                    }
...
export { DeclarativeArray, adoptDocument, adoptNode, adoptStyleSheet, adoptWindow, clearStyleSheet, createElement, createReactiveProperty, DDOM as default, define };
